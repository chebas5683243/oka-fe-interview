...
import { getRegions } from "../lib/api/get-regions";
import { getProvinces } from "../lib/api/get-provinces";
import { getDistricts } from "../lib/api/get-districts";
import { LocationsList } from "./location-list";

interface ChallengeProps {
  enableLocationQuery?: boolean;
}

export function Challenge({ enableLocationQuery = false }: ChallengeProps) {
      ...
      <section className="flex flex-col gap-4 w-full">
        ...
        <div className="grid grid-cols-3 gap-10 border-2 rounded-xl p-5 bg-gray-100">
          <LocationsList
            ...
            enableQuery={enableLocationQuery}
          />
          <LocationsList
            title="Provinces"
            locations={provinces}
